...
SwfAdapter = (function() {
  ...
  SwfAdapter.prototype.ensureActivityTypeRegistered = function() {
    ...
    return this.swf.describeActivityTypeAsync(describeParams)["catch"](error.isUnknownResourceError, (function(_this) {
      return function() {
        return _this.swf.registerActivityTypeAsync({
  ...
  SwfAdapter.prototype.pollForActivityTaskAsync = function() {
  ...
  SwfAdapter.prototype.recordHeartbeat = function(taskToken, details) {
    return this.swf.recordActivityTaskHeartbeatAsync({
      taskToken: taskToken,
      details: details
    });
  };
